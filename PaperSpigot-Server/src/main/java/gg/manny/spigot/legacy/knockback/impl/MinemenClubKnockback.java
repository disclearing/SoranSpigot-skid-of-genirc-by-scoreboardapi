...
@Getter
public class MinemenClubKnockback extends Knockback {

	private double vertical = 0.86D;
	private double horizontal = 0.9D;

	@Override
	public KnockbackType getKnockback() {
		return KnockbackType.MINEMENCLUB;
	}
