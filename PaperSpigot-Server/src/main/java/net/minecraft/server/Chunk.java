...
public class Chunk {
    ...
    public Set<EntityPlayer> getPlayers() {
        return (this.players == null) ? Collections.EMPTY_SET : this.players;
    }
    ...
    public Chunk(World world, int i, int j) {
        ...
        this.players = null;
        this.allEntities = Lists.newArrayListWithExpectedSize(16);
        this.v = new byte[256];
        this.b = new int[256];
    ...
    public void a(Class oclass, AxisAlignedBB axisalignedbb, List list, IEntitySelector ientityselector) {
        ...
        i = MathHelper.a(i, 0, this.entitySlices.length - 1);
        j = MathHelper.a(j, 0, this.entitySlices.length - 1);
        if (EntityPlayer.class.isAssignableFrom(oclass)) {
            if (this.players == null || this.players.isEmpty()) {
                return;
            }
            for (Entity entity : this.players) {
                if (entity.boundingBox.b(axisalignedbb) && (ientityselector == null || ientityselector.a(entity))) {
                    list.add(entity);
                }
            }
            return;
    ...
    public void loadNearby(IChunkProvider ichunkprovider, IChunkProvider ichunkprovider1, int i, int j) {
        if (GenericSpigot.INSTANCE.getConfig().isDisableLoadingNearbyChunks()) return;
    ...
    public void b(boolean flag) {
        if (!GenericSpigot.INSTANCE.getConfig().isDisableRecheckGaps() && this.w && !this.world.worldProvider.g && !flag) {
