...
public abstract class Entity {
    ...
    public double e(double d0, double d1, double d2) {
        return this.distanceSquared(d0, d1, d2);
    }
    ...
    public double distanceSquared(final Entity entity) {
        return this.distanceSquared(entity.locX, entity.locY, entity.locZ);
    }
    ...
    public void collide(Entity entity) {
        if (!GenericSpigot.INSTANCE.getConfig().isDisableEntityCollisions() && entity.passenger != this && entity.vehicle != this) {
