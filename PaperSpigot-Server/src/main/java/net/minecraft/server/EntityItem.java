...
public class EntityItem extends Entity {
    ...
    public void b_(EntityHuman entityhuman) {
        if (!this.world.isStatic) {
            if (!((EntityPlayer)entityhuman).getBukkitEntity().canSeeExtra(getBukkitEntity())) {
                return;
            }
    ...
    public EntityLiving getThrower() {
        if ((this.thrower == null) && (this.g != null) && (this.g.length() > 0)) {
            this.thrower = this.world.a(this.g);
        }
        return (this.thrower instanceof EntityLiving) ? (EntityLiving)this.thrower : null;
    }
}
