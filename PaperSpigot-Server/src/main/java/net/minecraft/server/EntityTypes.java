...
public class EntityTypes {
    ...
    private static void a(Class oclass, String s, int i, int j, int k) {
        a(oclass, s, i);
        eggInfo.put(i, new MonsterEggInfo(i, j, k));
    }

    public static Class getEntityClassByName(String s) {
    ...
    public static int a(Entity entity) {
        ...
        return f.containsKey(oclass) ? (Integer) f.get(oclass) : 0;
    }

    public static Class a(int i) {
        return (Class) e.get(i);
    }
