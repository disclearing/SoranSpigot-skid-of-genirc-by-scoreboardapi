...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
    ...
    public Queue<FutureTask> z = new ConcurrentLinkedQueue<>();
    public Queue<Runnable> processQueue = new ConcurrentLinkedQueue<>();
    public int autosavePeriod;
    // CraftBukkit end
    
    // CraftSpigot start - add latest Connection Time
    public static long latestConnectionTickTime = 0L;
    public static long lastTickTime = -1L;
    // CraftSpigot end
    ...
    public MinecraftServer(OptionSet options, Proxy proxy) { // CraftBukkit - signature file -> OptionSet
        ...
        this.serverThread = primaryThread = new ThreadServerApplication(this, "Server thread"); // Moved from main
        ...
        try {
            if (this.init()) {
                ...
                while (this.isRunning) {
                    ...
                    this.u();
                    MinecraftServer.lastTickTime = System.nanoTime() - curTime;
                    this.O = true;
                }
                // Spigot end
            } else {
    ...
    public <V> ListenableFuture<V> a(Callable<V> callable) {
        ...
        if (!isMainThread()) {
            ...
            this.processQueue.add(listenablefuturetask);
