...
public final class CraftServer implements Server {
    ...
    public boolean dispatchCommand(CommandSender sender, String commandLine) {
        ...
        if (org.spigotmc.SpigotConfig.logCommands) {
            this.getServer().info(sender.getName() + " issued server command (forced): " + commandLine);
        }

        if (sender instanceof Player) {
            PlayerCommandPreprocessEvent event = new PlayerCommandPreprocessEvent((Player) sender, "/" + commandLine, new LazyPlayerSet());
            ...
            ServerCommandEvent event = new org.bukkit.event.server.ServerCommandEvent(sender, commandLine);
    ...
    public void reload() {
        ...
        resetRecipes();
        GenericSpigot.INSTANCE.registerCommands(); // GenericSpigot
