    ...
    public static void main(String[] args) throws IOException {
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            if (!new File("update-lock").exists() && !lock.exists() && System.getProperty("IReallyKnowWhatIAmDoingThisUpdate") == null) {
                System.err.println("\n*** This Minecraft update alters the way in which saved data is stored. ***\n");
                lock.createNewFile();
            }
            System.err.println( "GenericSpigot build only supports Minecraft 1.7.x and 1.8.x clients!\n"
                    + "Please report issues directly to Manny, and always ensure you're up-to-date!\n"
